...
const handleSignIn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const findEmail = yield (0, user_service_1.getUserByEmail)(email);
        if (!findEmail) {
            return res.sendStatus(404);
        }
        const match = yield bcrypt_1.default.compare(password, findEmail.password);
        if (match) {
            const roles = yield (0, roles_service_1.getUserRoles)(findEmail.id);
            ...
            yield (0, auth_service_1.storeRefreshToken)(findEmail.id, refreshToken);
